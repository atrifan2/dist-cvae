...
#        pdb.set_trace()
       ...
       # convert_to_tfr_1(val_data, './float-val.tfrecords')
        ...
        #del(val_data)
     #   pdb.set_trace()
        train_dataset = input_fn(batch_size, is_training=True, params=None)
        val_dataset = input_fn(batch_size, is_training=False, params=None)
        
        #self.steps_per_epoch=(len(train_dataset)/batch_size)//hvd.size()
        
        self.steps_per_epoch=(96000/batch_size)//hvd.size()
        #pdb.set_trace()
